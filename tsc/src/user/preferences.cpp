...
// Keyboard
const sf::Keyboard::Key cPreferences::m_key_up_default = sf::Keyboard::Key::Up;
const sf::Keyboard::Key cPreferences::m_key_down_default = sf::Keyboard::Key::Down;
const sf::Keyboard::Key cPreferences::m_key_left_default = sf::Keyboard::Key::Left;
const sf::Keyboard::Key cPreferences::m_key_right_default = sf::Keyboard::Key::Right;
const sf::Keyboard::Key cPreferences::m_key_jump_default = sf::Keyboard::Key::S;
const sf::Keyboard::Key cPreferences::m_key_shoot_default = sf::Keyboard::Key::Space;
const sf::Keyboard::Key cPreferences::m_key_item_default = sf::Keyboard::Key::Enter;
const sf::Keyboard::Key cPreferences::m_key_action_default = sf::Keyboard::Key::A;
const sf::Keyboard::Key cPreferences::m_key_screenshot_default = sf::Keyboard::Key::P;
const sf::Keyboard::Key cPreferences::m_key_editor_fast_copy_up_default = sf::Keyboard::Key::Numpad8;
const sf::Keyboard::Key cPreferences::m_key_editor_fast_copy_down_default = sf::Keyboard::Key::Numpad2;
const sf::Keyboard::Key cPreferences::m_key_editor_fast_copy_left_default = sf::Keyboard::Key::Numpad4;
const sf::Keyboard::Key cPreferences::m_key_editor_fast_copy_right_default = sf::Keyboard::Key::Numpad6;
const sf::Keyboard::Key cPreferences::m_key_editor_pixel_move_up_default = sf::Keyboard::Key::Numpad8;
const sf::Keyboard::Key cPreferences::m_key_editor_pixel_move_down_default = sf::Keyboard::Key::Numpad2;
const sf::Keyboard::Key cPreferences::m_key_editor_pixel_move_left_default = sf::Keyboard::Key::Numpad4;
const sf::Keyboard::Key cPreferences::m_key_editor_pixel_move_right_default = sf::Keyboard::Key::Numpad6;
