...
ExternalProject_Add(
  ...
  PATCH_COMMAND patch -p1 < "${TSC_SOURCE_DIR}/../cegui-cpp11.patch" && patch -p1 < "${TSC_SOURCE_DIR}/../cegui-cmake-policy.patch" && patch -p1 < "${TSC_SOURCE_DIR}/../cegui-stb-greyscale.patch"
  LIST_SEPARATOR |
